...
function calcul(answers: Answers) {
  ...
  const [wMin, wMax] = WATT_BY_TYPE[type] || [40, 60]
    ...
    <div>
      ...
      <div className="border-t-2 border-wdd-yellow bg-white/5 p-5 mb-4">
        ...
        <div className="bg-black/20 p-3 mb-4">
          <div className="text-xs text-white/30 mb-1">Fourchette de prix forage seul HT VA</div>
      ...
      <button
        onClick={onPrecis}
        className="block w-full py-3 border border-wdd-yellow text-wdd-yellow text-sm font-semibold text-center hover:bg-wdd-yellow/10 transition-colors mb-1"
      >
